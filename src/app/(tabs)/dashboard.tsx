...
export default function DashboardScreen() {
  ...
  const estadoColor = hasCritical ? colors.statusCritical : active.length > 0 ? colors.statusWarn : colors.statusOk;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Pressable onPress={() => router.push("/(tabs)/alertas")} style={styles.bellBtn}>
      ...
      {active.length > 0 && (
        <TouchableOpacity
          ...
          style={[
            styles.alertBanner,
            {
              backgroundColor: hasCritical ? "rgba(239,68,68,0.07)" : "rgba(234,179,8,0.07)",
              borderColor: hasCritical ? colors.statusCritical : colors.statusWarn,
            },
          ]}
          activeOpacity={0.7}
        >
          <Icon name="alert-triangle" size={16} color={hasCritical ? colors.statusCritical : colors.statusWarn} />
      ...
      {toast && (
        <View
          style={[
            styles.toast,
            {
              backgroundColor: toast.type === "ok" ? colors.statusOkTint : "rgba(107,114,128,0.15)",
              borderColor: toast.type === "ok" ? colors.statusOk : colors.borderDefault,
            },
          ]}
        >
...
const makeStyles = (c: ThemeColors) =>
  StyleSheet.create({
    ...
    toastText: { flex: 1, fontSize: 13, fontWeight: FontWeight.semibold, fontFamily: fontFamilyForWeight(FontWeight.semibold) },
