    ...
    >
      <View
        style={[
          styles.deviceIcon,
          {
            backgroundColor: online ? "rgba(34,197,94,0.12)" : colors.surfaceInput,
          },
        ]}
      >
        <Icon
          name="wifi"
          size={20}
          color={online ? colors.actionPrimary : colors.textSecondary}
        />
      </View>
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.deviceNameRow}>
          ...
          <View
            style={[
              styles.statusDot,
              { backgroundColor: online ? colors.statusOk : colors.textSecondary },
            ]}
          />
        </View>
        <Text style={[styles.deviceMeta, { color: colors.textSecondary }]}>
          {device.silo} · {device.lastSync}
        </Text>
      </View>
...
export default function LanzasScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg }]}>
      ...
      <View style={[styles.header, { borderBottomColor: colors.borderDefault }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Mis lanzas</Text>
      </View>
      ...
      >
        ...
        <View style={styles.summaryRow}>
          ...
          >
            <Text style={[styles.summaryValue, { color: colors.actionPrimary }]}>
              {onlineCount}
            </Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          onPress={() => Alert.alert("Vincular lanza", "Función disponible próximamente.")}
        >
          <Icon name="plus-circle" size={18} color={colors.actionPrimary} />
          <Text style={[styles.addBtnText, { color: colors.actionPrimary }]}>
